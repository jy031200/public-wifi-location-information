...
<%
    ...
    if (lat != null && lng != null && !lat.trim().isEmpty() && !lng.trim().isEmpty()) {
        ...
        try {
            ...
            // SQL 쿼리 준비
            String sql = "SELECT * FROM location_data ORDER BY distance_num ASC LIMIT 20";//"SELECT  * FROM location_data LIMIT 2"; // 수정된 부분
            ...
            // int rowsAffected = statement.executeUpdate(); // 수정된 부분: 이 부분은 삭제되어야 합니다.
