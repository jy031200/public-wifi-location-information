...
public class FetchWifiInfoServlet extends HttpServlet { // 총 데이터 갯수 반환(load-wifi.jsp)
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String apiUrl = "http://openapi.seoul.go.kr:8088/4f667541706a793033374666544d75/json/TbPublicWifiInfo/1/10/";
        ...
        try {
            ...
            request.getRequestDispatcher("load-load-wifi.jsp").forward(request, response);
