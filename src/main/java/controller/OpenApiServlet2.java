...
import com.example.demo.SaveDataToDB;
...
public class OpenApiServlet2 extends HttpServlet {
    ...
    private static final String API_URL_TEMPLATE = "http://openapi.seoul.go.kr:8088/4f667541706a793033374666544d75/json/TbPublicWifiInfo/%d/%d/";
